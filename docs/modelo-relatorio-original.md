...
> Modelo original fornecido pelo instrutor do desafio DIO, preservado como anexo. O único ajuste feito aqui foi a correção de codificação de caracteres do arquivo original (que chegou com problemas de acentuação) — nenhuma palavra ou estrutura de conteúdo foi alterada.
